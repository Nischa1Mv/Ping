  ...
  return (
    <>
      ...
      <div className="w-screen h-screen p-10 ">
        <div className=" h-full  bg-[#191a22]  ">
          <div
            className="flex flex-col border-4  border-transparent bg-[rgba(143,143,202,0.1)] h-[35%] relative bg-no-repeat bg-center bg-cover"
            style={{
