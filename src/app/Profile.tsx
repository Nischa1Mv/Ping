  ...
  return (
    <>
      <div className="w-full h-full relative  ">
        <div
          className="flex flex-col bg-[rgba(143,143,202,0.1)] h-[30%] relative bg-no-repeat bg-center bg-cover"
          style={{
        ...
        <div className="font-bold  text-xl flex gap-4 text-[#CACA8F]  items-center px-8">
          Nischal_Mantri{" "}
          <svg
            xmlns="http://www.w3.org/2000/svg"
            height="24px"
        ...
        <div className="text-xs  text-[#adaeb7]  pl-8">@nischal_mantri </div>
        <div className=" pl-8 pt-4 flex flex-col gap-1 border-b-2 py-10">
          <div className="text-[#8888d5] text-md">Bio</div>
